...
export default function FilterSheet({
    ...
    return (
        <div
            className={`fixed inset-0 z-40 flex flex-col items-center justify-end transition-all duration-300 ease-in-out ${isOpen
            ...
            >
                ...
                <div className="w-full rounded-t-2xl bg-white flex flex-col" style={{ maxHeight: "80vh" }}>
                    ...
                    <div className="flex flex-1 overflow-hidden">
                        {/* Left sidebar tabs */}
                        <div className="w-[140px] shrink-0 bg-[#F9FAFB] overflow-y-auto border-r border-[#E6EAF0]">
                            {tabs.map((tab) => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`w-full h-[40px] px-4 py-[8px] text-sm font-medium flex items-center justify-between gap-2 border-l-[2px] transition-colors ${isActive
