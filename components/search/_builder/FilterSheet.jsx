...
export default function FilterSheet({
  ...
  const toggleLocalCategory = (value) =>
    setLocalCategories((prev) => (prev.includes(value) ? prev.filter((c) => c !== value) : [...prev, value]));
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full h-[40px] px-4 py-[8px] text-sm font-medium flex items-center justify-between gap-2 border-l-[2px] transition-colors ${
                      isActive
