...
export const COMBO_OVERRIDE_TERMS = ["gift", "gifts", "kit", "kits", "set", "sets", "pack", "packs", "combo", "combos"];
...
const typesenseInstantsearchAdapter = new TypesenseInstantSearchAdapter({
  ...
  collectionSpecificSearchParameters: {
    products: {
      query_by: "title,subtitle,concerns,categories,collections,ingredients,additional_ingredients,short_code",
      query_by_weights: "25,22,15,6,1,100,101,5",
    ...
    combo_products: {
      query_by: "title,subtitle,concerns,categories,collections,short_code",
      query_by_weights: "25,22,15,6,1,5",
      max_facet_values: 200,
      num_typos: 2,
      typo_tokens_threshold: 1,
      min_len_1typo: 3,
