...
export const TYPESENSE_INDEXES = {
  ...
  PRODUCTS_POPULARITY_HIGH_LOW: "products/sort/popularity_score:desc",
  // PRODUCTS_POPULARITY_LOW_HIGH: "products/sort/popularity_score:asc",
  ...
  COMBO_PRODUCTS_POPULARITY_HIGH_LOW: "combo_products/sort/popularity_score:desc",
  // COMBO_PRODUCTS_POPULARITY_LOW_HIGH: "combo_products/sort/popularity_score:asc",
...
const typesenseInstantsearchAdapter = new TypesenseInstantSearchAdapter({
  ...
  collectionSpecificSearchParameters: {
    products: {
      query_by: "title,subtitle,short_code,additional_ingredients,ingredients,gender,concerns,categories,collections",
