...
const typesenseInstantsearchAdapter = new TypesenseInstantSearchAdapter({
  ...
  collectionSpecificSearchParameters: {
    products: {
      query_by:
        "title,subtitle,additional_ingredients,ingredients,gender,concerns,categories,collections,target_age_group",
      query_by_weights: "101,100,80,70,60,50,5,2,1",
      sort_by: "popularity_score:desc",
      max_facet_values: 200,
      prefix: "true,false,false,false,false,false,false,false,false",
      num_typos: "2,1,0,0,0,1,1,1,0",
